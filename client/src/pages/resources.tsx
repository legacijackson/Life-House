...
function Resources() {
  ...
  const pageTitle = isGuest ? "Community Resources" : "Resources";
  const pageDescription = isGuest ? "Find support services in your area" : "Find and manage community resources";
